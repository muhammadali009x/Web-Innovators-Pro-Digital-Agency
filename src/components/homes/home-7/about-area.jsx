...
const about_content = {
    ...
    about_P_title: `Welcome to HV Digital—Your Trusted Partner in Web Development
`,
    des: `At HV Digital, we’re not just an agency; we’re your partner in creating high-quality websites and web applications that make an impact. With our main office in Boston and team members located across the U.S. and Europe, we seamlessly blend local expertise with global perspective.
`,
}
...
const about_feature_data = [
    ...
    },
    {
        ...
        text: <>Tailored Advssssice <br /> & Support</>
    },
]
