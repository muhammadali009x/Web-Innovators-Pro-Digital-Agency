...
const job_details_content = {
    ...
    job_description: <>At Web Innovators Pro, we are building preventive, continuous and personalized primary
    ...
    include_files: [
        ...
        <>A few words describing why you want to join Web Innovators Pro</>,
    ],
