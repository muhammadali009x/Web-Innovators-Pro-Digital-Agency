                ...
                <div className="it-cta__title">
                  <div className="section-title-wraper">
                    <div className="tp-section">
                      ...
                      <p>Got a Symfony project in mind? We’d love to hear all about it! Simply fill out the form, and our team will get in touch within one working day. Prefer a more direct approach? Feel free to give us a call or shoot us an email. Let's get started and bring your project to life!
                      </p>
                    </div>
                  </div>
                </div>
