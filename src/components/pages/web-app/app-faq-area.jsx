        ...
        <div className="container">
          <div className="row align-items-lg-center align-items-xl-start">
            ...
            >
              <div className="section-title-wraper">
                <div className="tp-section">
                  ...
                  <h2 className="tp-section__title mb-30 text-mirage">
                    Questions We Hear All the Time About Web Apps
                  </h2>
                  <p>Thinking about developing a web application but not sure what it involves? Here are some of the most common questions we get (and our answers to help you feel confident about moving forward!).
                  </p>
                </div>
              </div>
              <div
              ...
              <p className="text-center">Have more questions? We love talking shop—reach out to our team anytime. Let's build something amazing together!
              </p>
            </div>
