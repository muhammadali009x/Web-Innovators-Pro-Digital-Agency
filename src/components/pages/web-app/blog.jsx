import our_blog_data from '@/src/components/Insights/data';
        ...
        <>
            <div className="tp-app-blog pt-120 pb-90">
                <div className="container">
                    ...
                    <div className="row">
                        {
                            our_blog_data.filter(item => [6, 17, 13, 19].includes(item.id)).map((item, i) =>
                                ...
                                <div key={i} className="col-xl-3 col-lg-6">
                                    <div className="it-blog app-blog mb-30 wow tpfadeUp" data-wow-delay=".5s">
                                        ...
                                        <div className="it-blog-info app-blog-info white-bg">
                                            ...
                                            <h3 className="it-blog__title fz-20 text-mirage"><Link href={item.link}>
                                                {item.title}
                                                there </Link></h3>
