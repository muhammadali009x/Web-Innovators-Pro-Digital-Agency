...
const terms_conditions_content = {
    ...
    des: <>This Terms of Service (the “Terms”) describes the rights and responsibilities
            ...
            “Service”), each owned and operated by Web Innovators Pro Holdings Ltd. (“Web Innovators Pro”, “we”, “our” or
            “us”).<br />
            Please read the Terms carefully before using the Service. If you don’t agree to the Terms, as
            well as Dribbble’s Privacy Policy (the “Privacy Policy”) and Web Innovators Pro’s
    ...
    terms_list : [
        {
            id: "01",
            text: <>Your Web Innovators Pro Account. If you create an account on the Service (your “Account”), you are
                ...
                of others, and Web Innovators Pro may change or remove any description or keyword that it considers
                inappropriate or unlawful, or otherwise likely to cause Web Innovators Pro
                liability. You must immediately notify Web Innovators Pro of any unauthorized uses of your Account or
                any
                other breaches of security. Web Innovators Pro will not be liable for
        ...
        },
        {
            ...
            text: <>Fees and Renewals. Pricing for Paid Accounts will be provided at the time of purchase.
                    ...
                    by Web Innovators Pro, fees for a Paid Account will be billed in advance for each year and are
